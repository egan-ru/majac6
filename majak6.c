...
//
//	Программа для PIC12F675 с генератором на кварце 8МГц
//	Предназначена для выделения сигнала точного времени
//	из "Радио Маяк" с замерами длительности 6-ого сигнала
//  для выяснения часа по Московскому времени т.к. передается оно
//  только по Московскому времени
//	Автор: Новосёлов Игорь Валерьевич г.Екатеринбург
//	imeda@yandex.ru	- для вопросов
//	Хотелось бы иметь отзывы об разработке, особенно про недостатки
//	компиллер был Хитеч 9.50
//  2006г.
